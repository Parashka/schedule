document.addEventListener("DOMContentLoaded", function() {
  ...
  function createScheduleTables() {
    ...
    for (var i = 0; i < daysOfWeek.length; i++) {
      ...
      var tableContent = '<tr><th colspan="4">' + daysOfWeek[i] + '</th></tr><tr><th>№ пары</th><th>Время</th><th>Предмет</th><th>Преподаватель</th></tr>';
  
      for (var j = 1; j <= 5; j++) {
        tableContent += '<tr><td style="width: 25px; text-align: center;">' + j + '</td><td contenteditable="true"></td><td contenteditable="true"></td><td contenteditable="true"></td></tr>';
      }
